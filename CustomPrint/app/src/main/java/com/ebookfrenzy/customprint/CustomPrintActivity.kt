    ...
    inner class MyPrintDocumentAdapter(private var context: Context)
        ...
        private fun drawPage(page: PdfDocument.Page,
            ...
            canvas.drawText(
                    ...
                    paint)
            paint.textSize = 14f
            canvas.drawText("This is some test content to verify that custom document printing works", leftMargin.toFloat(), (titleBaseLine + 35).
            toFloat(), paint)
            if (pagenum % 2 == 0)
